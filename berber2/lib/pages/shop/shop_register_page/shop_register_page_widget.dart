...
import 'shop_register_page_model.dart';
export 'shop_register_page_model.dart';

/// I am trying to create a page for my application called barber where
/// barbers can register.
///
/// What I want you to do is to create a page that asks these questions to the
/// user and all the text on this page should be in Turkish.
class ShopRegisterPageWidget extends StatefulWidget {
  const ShopRegisterPageWidget({super.key});

  static String routeName = 'shop_register_page';
  static String routePath = '/shopRegisterPage';

  @override
  State<ShopRegisterPageWidget> createState() => _ShopRegisterPageWidgetState();
}

class _ShopRegisterPageWidgetState extends State<ShopRegisterPageWidget> {
  late ShopRegisterPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShopRegisterPageModel());
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                hintText: 'Salon adınızı giriniz',
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              obscureText: false,
                              decoration: InputDecoration(
                                hintText: 'Salon adresinizi giriniz',
                                hintStyle: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.inter(
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              'Çalışma Saatleri *(Çalışmadığınız Günleri Boş Bırakınız)',
                              style: FlutterFlowTheme.of(context)
                                  .labelLarge
                                  .override(
                                    font: GoogleFonts.inter(
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            TextFormField(
                              ...
                              decoration: InputDecoration(
                                hintText:
                                    'Dükkanınız hakkında bilgi verebilirsiniz',
                                hintStyle: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.inter(
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      context.pushNamed(VerifyNumberPage7Widget.routeName);
                    },
                    text: 'Kaydı Tamamla',
